...
export default function CarCard({ name, image, tags, deposit, pricing }: CarCardProps) {
  return (
    <div className="bg-[#98A2A6] rounded-[8px] md:rounded-[10px] flex flex-col md:flex-row gap-[25px] md:gap-[50px] p-3 md:pl-5 md:pr-[50px] md:py-5 shadow-[0_0_50px_rgba(0,0,0,0.1),0_0_15px_rgba(0,0,0,0.3)] h-full">
      {/* Фото + кнопка - на мобільному вертикально */}
      <div className="flex flex-col gap-[10px] md:shrink-0">
        <div className="w-full md:w-[317px] h-[199.5px] md:h-[265px] bg-gray-300 rounded-[8px] md:rounded-[10px] relative overflow-hidden">
          <Image
            src={image}
            alt={name}
            fill
        ...
        <a 
          ...
          className="w-full md:w-[317px] h-[36px] md:h-[45px] bg-[#070707] rounded-[8px] md:rounded-[10px] flex items-center justify-center gap-[10px] px-[15px] md:px-[30px] py-3 md:py-[15px] hover:bg-[#1a1a1a] transition-colors"
        >
      ...
      {/* Інформація */}
      <div className="flex flex-col justify-center gap-[15px] md:gap-5 md:py-[10px]">
        {/* Назва */}
        <h3 
          className="text-[#070707] text-[18px] md:text-2xl font-black leading-[120%]"
