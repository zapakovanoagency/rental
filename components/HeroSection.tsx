...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 text-left md:text-center w-full  md:max-w-none flex flex-col items-start md:items-center gap-[248px] md:gap-[193px] xl:gap-[220px] 2xl:gap-[250px]">
        <h1 
          className="text-white text-[30px] leading-[100%] md:text-[70px] max-w-[290px] md:max-w-none lg:text-[80px] xl:text-[100px] 2xl:text-[120px] md:leading-[100%] lg:leading-[80px] xl:leading-[100px] 2xl:leading-[120px] font-black uppercase whitespace-pre-line"
          style={{ 
        ...
        <a
          ...
          className=" w-full md:w-[469px] lg:w-auto h-[42px] md:h-16 lg:h-auto px-5 md:px-[50px] lg:px-[50px] xl:px-[60px] 2xl:px-[70px] py-[14px] md:py-5 xl:py-6 2xl:py-7 rounded-[8px] md:rounded-[10px] text-white text-xs md:text-2xl xl:text-3xl 2xl:text-4xl font-bold uppercase transition-all duration-300 hover:scale-110 hover:shadow-[0_0_80px_rgba(255,68,0,0.6),0_0_30px_rgba(217,19,0,0.8)] relative overflow-hidden group flex items-center justify-center gap-[10px] "
          style={{ 
            fontFamily: 'var(--font-unbounded)',
