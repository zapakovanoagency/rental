  ...
  return (
    <>
      <a
        ...
        className="floating-phone-btn fixed top-40 lg:top-auto lg:bottom-8 right-[15px] md:right-[50px] lg:right-8 z-50 w-[60px] h-[60px] md:w-[70px] md:h-[70px] lg:w-[80px] lg:h-[80px] bg-[#FF4400] rounded-full flex items-center justify-center transition-all duration-300 animate-pulse-shadow group"
