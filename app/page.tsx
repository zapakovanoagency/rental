...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="autopark" className="bg-[#DDDDDD] px-[15px] md:px-[50px] lg:px-[50px] xl:px-[60px] 2xl:px-[150px] py-[60px] md:py-[100px] lg:py-[150px] xl:py-[180px] 2xl:py-[200px]">
